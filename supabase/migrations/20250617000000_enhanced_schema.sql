...
--     - Add roll_number as primary key
--     - Add register_number as unique identifier
--     - Add department field
--     - Add shift field (1 or 2)
...
-- -- Set roll_number as the new primary key
-- ALTER TABLE students ADD PRIMARY KEY (roll_number);

-- -- Add unique constraint to register_number
-- ALTER TABLE students ADD CONSTRAINT students_register_number_key UNIQUE (register_number);
